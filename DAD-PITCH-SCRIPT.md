...
Facts live in CORE-NARRATIVE.md. Objection detail lives in PLAYBOOK.md. Where this conflicts with those, those win — update them first, then this.

---

## The Operating Principle — Relationship First, Ask Last (90/10)

This pitch is built 90/10. The first ninety percent builds the relationship with the *idea*: the person comes to understand what you've actually built, picks at it, and arrives at belief on their own terms. Only the last ten percent asks for anything.

This is not hiding the ask. The person knows an investment conversation is coming — you told them so when you set the meeting. What you're doing is *sequencing*: relationship and credibility first, money last. The fastest way to damage both the deal and the relationship is to ask for the sale before the person believes in the thing. So you don't. You let the idea earn its own buy-in, and only then do you ask.

**This is the opposite of a Phase-1 hard close.** No version of "so, are you in?" appears until Phase 4. If you feel yourself reaching for the ask early, you're breaking the structure.

---

## The Mindset You Walk In With (the "dad" frame, generalized)

You are handing the sharpest person in the room the red pen *on purpose*. You want them to pick it apart. When a serious person stress-tests something real and it holds, they don't just consider backing it — they repeat it to other people. Their scrutiny is the engine, not the obstacle.

With your father specifically: he reads people across a table for money for a living. He will feel a manufactured close instantly. That's the whole reason the structure is relationship-first and honest — not because honesty is the soft option, but because with him it is the *only* option that survives contact. Walk in wanting the hard questions. The harder he goes at it and the better it holds, the closer you are.

---

## PHASE 0 — Setting the Meeting

Goal: lock one sit-down as the business conversation, framed honestly, without killing the trip energy.
...
**Pick the night well.** Not the first night (everyone's amped), not after the late game (tired). Mid-trip, earlier dinner, quiet enough to talk numbers. Materials stay in the bag until Phase 4.
...
## PHASE 3 — Letting Him Probe (where the deal is actually won)

He's a financial advisor. He *will* go after the numbers. Welcome it. A calm, specific answer to a hard question is the single most persuasive thing that happens all night — because it *is* the credibility, not a detour from it.

**Posture rules:**
- Never get defensive. Specific and unbothered beats clever every time.
- This is where APCL lives. APCL is a relationship technique — and with this pitch the relationship *is* the sale, so that's not a contradiction. What it's not is a hard close. When a concern comes up: acknowledge it genuinely (you're on their side of the question), fold it back toward where you're already leading, settle it honestly, then bring the focus back to the relationship and the shared build. The point is that a business detail never becomes the emotional center of the dinner.
- The answer just has to be true and the next beat ready. No status games, no borrowed social proof, no "everyone who invests says X" — those are the opposite of what APCL is for, and he'd read them instantly.
- Pull the full answers from PLAYBOOK.md. Below is how to *carry* them.
...
## PHASE 5 — If He Wants His Lawyer / Financial People First
...
## PHASE 6 — If It's a No (or a not-yet)
...
*Delivery document. Source of truth for facts is CORE-NARRATIVE.md; objection detail is PLAYBOOK.md. If anything here conflicts, those win — update them first, then this.*
